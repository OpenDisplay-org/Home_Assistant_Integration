...
from .entity import OpenDisplayAPEntity, OpenDisplayTagEntity
...
class OpenDisplayTextDescription(TextEntityDescription):
...
AP_TEXT_ENTITIES: tuple[OpenDisplayTextDescription, ...] = (
    OpenDisplayTextDescription(
        key="alias",
...
class APConfigText(OpenDisplayAPEntity, TextEntity):
    """Text entity for AP configuration."""

    entity_description: OpenDisplayTextDescription

    def __init__(self, hub, description: OpenDisplayTextDescription) -> None:
...
class TagNameText(OpenDisplayTagEntity, TextEntity):
