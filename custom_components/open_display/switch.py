...
from .entity import OpenDisplayAPEntity
...
class OpenDisplaySwitchDescription(SwitchEntityDescription):
...
SWITCH_ENTITIES: tuple[OpenDisplaySwitchDescription, ...] = (
    OpenDisplaySwitchDescription(
        key="preview",
...
class APConfigSwitch(OpenDisplayAPEntity, SwitchEntity):
    """Switch entity for AP configuration."""

    entity_description: OpenDisplaySwitchDescription

    def __init__(self, hub, description: OpenDisplaySwitchDescription) -> None:
