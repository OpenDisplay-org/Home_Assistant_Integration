...
from .protocol_open_display import OpenDisplayProtocol
...
_PROTOCOLS: dict[int, BLEProtocol] = {
    ...
    0x2446: OpenDisplayProtocol(),  # OpenDisplay firmware (9286 decimal)
}
...
def get_protocol_by_name(name: str) -> BLEProtocol:
    ...
    Args:
        name: Protocol name ('atc' or 'open_display')
